...
namespace DotNet.Kafka.MultiEventTopic
{
	...
	public partial class AccountClosed : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"AccountClosed\",\"namespace\":\"DotNet.Kafka.MultiEventTopic" +
				"\",\"fields\":[{\"name\":\"eventId\",\"type\":\"string\"},{\"name\":\"accountId\",\"type\":\"strin" +
				"g\"},{\"name\":\"occurredAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}" +
				"}]}");
